...
void test_pid_41_monitor_drive_cycle_status_valid_data() {
  ...
  MockMessage response = create_obd_response_4_bytes(0x7E8, SERVICE_01, 0x41, 0x12, 0x34, 0x56, 0x78);
...
void test_pid_41_monitor_drive_cycle_status_zero() {
  ...
  MockMessage response = create_obd_response_4_bytes(0x7E8, SERVICE_01, 0x41, 0x00, 0x00, 0x00, 0x00);
  g_mock_iso_tp.add_receive_message(response);
...
void test_pid_42_ctrl_mod_voltage_valid_data() {
  ...
  MockMessage response = create_obd_response_2_bytes(0x7E8, SERVICE_01, 0x42, 0x30, 0x39);
  g_mock_iso_tp.add_receive_message(response);
...
void test_pid_42_ctrl_mod_voltage_low() {
  ...
  MockMessage response = create_obd_response_2_bytes(0x7E8, SERVICE_01, 0x42, 0x27, 0x10);
  g_mock_iso_tp.add_receive_message(response);
...
void test_pid_43_abs_load_valid_data() {
  ...
  MockMessage response = create_obd_response_2_bytes(0x7E8, SERVICE_01, 0x43, 0x80, 0x00);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(0.1, 12850.196, load.value(), "absLoad должен вернуть правильную нагрузку");
}
...
void test_pid_43_abs_load_zero() {
  ...
  MockMessage response = create_obd_response_2_bytes(0x7E8, SERVICE_01, 0x43, 0x00, 0x00);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(0.01, 0.0, load.value(), "absLoad должен обрабатывать нулевую нагрузку");
}
...
void test_pid_44_commanded_air_fuel_ratio_valid_data() {
  ...
  MockMessage response = create_obd_response_2_bytes(0x7E8, SERVICE_01, 0x44, 0x80, 0x00);
  g_mock_iso_tp.add_receive_message(response);
...
void test_pid_44_commanded_air_fuel_ratio_max() {
  ...
  MockMessage response = create_obd_response_2_bytes(0x7E8, SERVICE_01, 0x44, 0xFF, 0xFF);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.001, 1.999969, ratio.value(), "commandedAirFuelRatio должен обрабатывать максимальное значение");
}
...
void test_pid_45_relative_throttle_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x45, 0x80);
  g_mock_iso_tp.add_receive_message(response);
...
void test_pid_45_relative_throttle_full_open() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x45, 0xFF);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.01, 100.0, throttle.value(), "relativeThrottle должен обрабатывать полностью открытую заслонку");
}
...
void test_pid_46_ambient_air_temp_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x46, 0x50);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(0.1, 40.0, temp.value(), "ambientAirTemp должен вернуть правильную температуру");
}
...
void test_pid_46_ambient_air_temp_negative() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x46, 0x14);
  g_mock_iso_tp.add_receive_message(response);
...
void test_pid_47_abs_throttle_pos_b_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x47, 0x80);
  g_mock_iso_tp.add_receive_message(response);
...
void test_pid_48_abs_throttle_pos_c_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x48, 0x40);
  g_mock_iso_tp.add_receive_message(response);
...
void test_pid_49_abs_throttle_pos_d_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x49, 0xC0);
  g_mock_iso_tp.add_receive_message(response);
...
void test_pid_4a_abs_throttle_pos_e_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x4A, 0x20);
  g_mock_iso_tp.add_receive_message(response);
...
void test_pid_4b_abs_throttle_pos_f_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x4B, 0xA0);
  g_mock_iso_tp.add_receive_message(response);
...
void test_pid_4c_commanded_throttle_actuator_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x4C, 0x80);
  g_mock_iso_tp.add_receive_message(response);

  OBD2 obd2(g_mock_iso_tp);
  auto actuator = obd2.commandedThrottleActuator();
  TEST_ASSERT_TRUE_MESSAGE(actuator.has_value(), "commandedThrottleActuator должен вернуть значение");

  // Ожидаемое значение: 128 * 100/255 = 50.196%
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.01, 50.196, actuator.value(), "commandedThrottleActuator должен вернуть правильное значение");
}
...
void test_pid_4d_time_run_with_mil_valid_data() {
  ...
  MockMessage response = create_obd_response_2_bytes(0x7E8, SERVICE_01, 0x4D, 0x12, 0x34);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_EQUAL_UINT16_MESSAGE(4660, time.value(), "timeRunWithMIL должен вернуть правильное время");
}
...
void test_pid_4e_time_since_codes_cleared_valid_data() {
  ...
  MockMessage response = create_obd_response_2_bytes(0x7E8, SERVICE_01, 0x4E, 0x56, 0x78);
  g_mock_iso_tp.add_receive_message(response);
  ...
  // Формула: (A*256 + B) минут
  TEST_ASSERT_EQUAL_UINT16_MESSAGE(22136, time.value(), "timeSinceCodesCleared должен вернуть правильное время");
}
...
void test_pid_50_max_maf_rate_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x50, 0x64);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.1, 1000.0, static_cast<double>(rate.value()), "maxMafRate должен вернуть правильный расход");
}
...
void test_pid_51_fuel_type_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x51, 0x01);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(1, fuel.value(), "fuelType должен вернуть правильный тип топлива");
}
...
void test_pid_52_ethanol_percent_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x52, 0x33);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(0.01, 20.0, ethanol.value(), "ethanolPercent должен вернуть правильный процент");
}
...
void test_pid_53_abs_evap_sys_vap_pressure_valid_data() {
  ...
  MockMessage response = create_obd_response_2_bytes(0x7E8, SERVICE_01, 0x53, 0x12, 0x34);
  g_mock_iso_tp.add_receive_message(response);
...
void test_pid_54_evap_sys_vap_pressure2_valid_data() {
  ...
  MockMessage response = create_obd_response_2_bytes(0x7E8, SERVICE_01, 0x54, 0x80, 0x00);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.1, 1.0, static_cast<double>(pressure.value()), "evapSysVapPressure2 должен вернуть правильное давление");
}
...
void test_pid_59_abs_fuel_rail_pressure_valid_data() {
  ...
  MockMessage response = create_obd_response_2_bytes(0x7E8, SERVICE_01, 0x59, 0x12, 0x34);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.1, 46600.0, static_cast<double>(pressure.value()), "absFuelRailPressure должен вернуть правильное давление");
}
...
void test_pid_5a_relative_pedal_pos_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x5A, 0x80);
  g_mock_iso_tp.add_receive_message(response);
  ...
  // Ожидаемое значение: 128 * 100/255 = 50.196%
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.01, 50.196, static_cast<double>(pedal.value()), "relativePedalPos должен вернуть правильное положение");
}
...
void test_pid_5b_hybrid_bat_life_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x5B, 0xCC);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.01, 80.0, static_cast<double>(life.value()), "hybridBatLife должен вернуть правильный ресурс");
}
...
void test_pid_5c_oil_temp_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x5C, 0x78);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.1, 80.0, static_cast<double>(temp.value()), "oilTemp должен вернуть правильную температуру");
}
...
void test_pid_5d_fuel_inject_timing_valid_data() {
  ...
  MockMessage response = create_obd_response_2_bytes(0x7E8, SERVICE_01, 0x5D, 0x6D, 0x60);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.1, 8.75, static_cast<double>(timing.value()), "fuelInjectTiming должен вернуть правильное время");
}
...
void test_pid_5e_fuel_rate_valid_data() {
  ...
  MockMessage response = create_obd_response_2_bytes(0x7E8, SERVICE_01, 0x5E, 0x0C, 0x80);
  g_mock_iso_tp.add_receive_message(response);
...
void test_pid_5f_emission_rqmts_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x5F, 0x05);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_EQUAL_UINT8_MESSAGE(5, emission.value(), "emissionRqmts должен вернуть правильные требования");
}
// ============================================================================
...
void test_pid_55_short_term_sec_oxy_trim_13_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x55, 0x80);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.1, 0.0, static_cast<double>(trim.value()), "shortTermSecOxyTrim13 должен вернуть правильную коррекцию");
}
...
void test_pid_55_short_term_sec_oxy_trim_13_positive() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x55, 0xFF);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.1, 99.2, static_cast<double>(trim.value()), "shortTermSecOxyTrim13 должен вернуть максимальную коррекцию");
}
...
void test_pid_56_long_term_sec_oxy_trim_13_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x56, 0x60);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.1, -25.0, static_cast<double>(trim.value()), "longTermSecOxyTrim13 должен вернуть правильную коррекцию");
}
...
void test_pid_56_long_term_sec_oxy_trim_13_negative() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x56, 0x00);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.1, -100.0, static_cast<double>(trim.value()), "longTermSecOxyTrim13 должен вернуть минимальную коррекцию");
}
...
void test_pid_57_short_term_sec_oxy_trim_24_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x57, 0xA0);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.1, 25.0, static_cast<double>(trim.value()), "shortTermSecOxyTrim24 должен вернуть правильную коррекцию");
}
...
void test_pid_57_short_term_sec_oxy_trim_24_zero() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x57, 0x80);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.1, 0.0, static_cast<double>(trim.value()), "shortTermSecOxyTrim24 должен вернуть нулевую коррекцию");
}
...
void test_pid_58_long_term_sec_oxy_trim_24_valid_data() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x58, 0xC0);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.1, 50.0, static_cast<double>(trim.value()), "longTermSecOxyTrim24 должен вернуть правильную коррекцию");
}
...
void test_pid_58_long_term_sec_oxy_trim_24_boundary() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x58, 0x40);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.1, -50.0, static_cast<double>(trim.value()), "longTermSecOxyTrim24 должен вернуть граничную коррекцию");
}
...
void test_pid_42_ctrl_mod_voltage_max() {
  ...
  MockMessage response = create_obd_response_2_bytes(0x7E8, SERVICE_01, 0x42, 0xFF, 0xFF);
  g_mock_iso_tp.add_receive_message(response);
...
void test_pid_46_ambient_air_temp_max() {
  ...
  MockMessage response = create_obd_response_1_byte(0x7E8, SERVICE_01, 0x46, 0xFF);
  g_mock_iso_tp.add_receive_message(response);
  ...
  TEST_ASSERT_FLOAT_WITHIN_MESSAGE(
      0.1, 215.0, static_cast<double>(temp.value()), "ambientAirTemp должен обрабатывать максимальную температуру");
}
